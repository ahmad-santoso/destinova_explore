...
<body class="relative">
    ...
    <div class="bg-white shadow-md rounded-lg mx-auto mt-5 w-full">
        <!-- Cover Photo -->
        <div class="relative h-40 bg-cover bg-center" style="background-image: url('https://images.pexels.com/photos/2662086/pexels-photo-2662086.jpeg?auto=compress&cs=tinysrgb&w=600');">
        </div>
        ...
        <div class="px-6 py-4">
            <div class="relative flex items-center">
                ...
                <div class="relative z-10 w-24 h-24 rounded-full border-4 border-white" style="margin-top: -4rem;">
                    <img src="https://images.pexels.com/photos/715546/pexels-photo-715546.jpeg?auto=compress&cs=tinysrgb&w=600" alt="Profile Picture" class="w-full h-full rounded-full object-cover">
                </div>
                
                <!-- User Info -->
                <div class="ml-4">
                    <h2 class="text-xl font-semibold">Admin Account</h2>
                    <p class="text-gray-600">admin@gmail.com</p>
                </div>

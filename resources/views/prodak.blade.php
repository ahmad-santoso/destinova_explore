    ...
    <ul class="mt-4 flex-1">
        ...
        <li class="mb-1 group">
            ...
            <ul class="pl-7 mt-2 hidden">
                <li class="mb-4">
                    <a href="#" class="text-gray-300 text-sm flex items-center hover:text-gray-100">Sales Reports</a>
                </li>
                <li class="mb-4">
                    <a href="#" class="text-gray-300 text-sm flex items-center hover:text-gray-100">User Reports</a>
                </li>
            </ul>
        </li>
        <li class="mb-1 group">
            ...
            <ul class="pl-7 mt-2 hidden">
                <li class="mb-4">
                    <a href="#" class="text-gray-300 text-sm flex items-center hover:text-gray-100">General Settings</a>
                </li>
                <li class="mb-4">

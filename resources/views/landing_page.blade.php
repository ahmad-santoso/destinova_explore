...
<body class="h-full">
            ...
            <div class="flex flex-1 items-center justify-end md:justify-between">
                <nav aria-label="Global" class="hidden md:block">
                    <ul class="flex items-center gap-6 text-sm">
                        ...
                        <li>
                            <a class="text-gray-500 transition hover:text-gray-500/75" href="#popular">Popular</a>
                        </li>

                        <li>
                            <a class="text-gray-500 transition hover:text-gray-500/75" href="#testimony">Testimony</a>
                        </li>

                        <li>
                            <a class="text-gray-500 transition hover:text-gray-500/75" href="#tour-packages">Tour
                                Packages</a>
                        </li>

                        <li>
                            <a class="text-gray-500 transition hover:text-gray-500/75" href="#gallery">Gallery</a>
                        </li>
                    </ul>
                </nav>
    ...
    <!-- Banner Sec -->
    <section id="home" class="relative bg-cover bg-center bg-no-repeat"
        style="background-image: url('{{ asset('assets/image (1).jpg') }}');">
        <div class="absolute inset-0 bg-black/50 lg:bg-black/30 lg:from-black/70 lg:to-black/30 lg:bg-gradient-to-r">
        </div>
